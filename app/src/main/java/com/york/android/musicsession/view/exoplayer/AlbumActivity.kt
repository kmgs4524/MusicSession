...
class AlbumActivity : AppCompatActivity() {
    ...
    fun initRecycleView(handler: Handler) {
        ...
        songs.add(Song("水", "吳汶芳", R.drawable.album_cover, 0, "/storage/emulated/0/Music/吳汶芳 - 我來自/吳汶芳-水.mp3"))
        songs.add(Song("我來自", "吳汶芳", R.drawable.album_cover, 0, "/storage/emulated/0/Music/吳汶芳 - 我來自/吳汶芳-我來自.mp3"))
        songs.add(Song("指南", "吳汶芳", R.drawable.album_cover, 0, "/storage/emulated/0/Music/吳汶芳 - 我來自/吳汶芳-指南.mp3"))
        songs.add(Song("美好", "吳汶芳", R.drawable.album_cover, 0, "/storage/emulated/0/Music/吳汶芳 - 我來自/吳汶芳-美好.mp3"))
        songs.add(Song("迷路汪洋", "吳汶芳", R.drawable.album_cover, 0, "/storage/emulated/0/Music/吳汶芳 - 我來自/吳汶芳-迷路汪洋.mp3"))
        songs.add(Song("散落的星空", "吳汶芳", R.drawable.album_cover, 0, "/storage/emulated/0/Music/吳汶芳 - 我來自/吳汶芳-散落的星空.mp3"))
        songs.add(Song("無窮", "吳汶芳", R.drawable.album_cover, 0, "/storage/emulated/0/Music/吳汶芳 - 我來自/吳汶芳-無窮.mp3"))
        songs.add(Song("總有一天", "吳汶芳", R.drawable.album_cover, 0, "/storage/emulated/0/Music/吳汶芳 - 我來自/吳汶芳-總有一天.mp3"))
